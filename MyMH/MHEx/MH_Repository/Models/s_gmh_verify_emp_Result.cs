...
namespace MH_Repository.Models
{
    ...
    public partial class s_gmh_verify_emp_Result
    {
        ...
        public string belong_center { get; set; }
        ...
        public string belong_center_desc { get; set; }
        public string mh_group_desc { get; set; }
        public string work_site { get; set; }
        public Nullable<System.DateTime> formal_enter { get; set; }
        public string on_resign { get; set; }
        public string is_flab { get; set; }
        public string resign_lock { get; set; }
    }
}
